		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item">
					...
					style="background-image: url(${pageContext.request.contextPath}/resources/bootstrap/images/nyfw-street-style-backless-loafers-lead-image.jpg)"></div>
									...
									<div class="home_content">
										...
										<div class="home_items">
											<div class="row">
												<div class="col-sm-3 offset-lg-1">
													<div class="home_item_side">
														<a href="product.html"><img
															src="${pageContext.request.contextPath}/resources/bootstrap/images/f19_04_a08_69727_16966_on_a.jpg" alt=""></a>
													</div>
												</div>
												<div
													...
													<div class="product home_item_large">
														...
														<div class="product_image">
															<img src="${pageContext.request.contextPath}/resources/bootstrap/images/4launch_0005_dsc04732.jpg" alt="">
														</div>
																...
																<div>
																	<div>
																		<div class="product_name">
																			<a href="product.html">Cool Clothing with Brown
																				Stripes</a>
																		</div>
															...
															<div class="product_buttons">
																<div
																	...
																	<div
																		...
																		<div>
																			<div>
																				<img src="${pageContext.request.contextPath}/resources/bootstrap/images/heart.svg" alt="">
																				<div>+</div>
																			</div>
																		</div>
																	</div>
												...
												<div class="col-sm-3">
													<div class="home_item_side">
														<a href="product.html"><img src="${pageContext.request.contextPath}/resources/bootstrap/images/home_3.jpg"
															alt=""></a>
													</div>
												</div>
											</div>
				...
				<div class="owl-item">
					<div class="background_image"
						style="background-image: url(${pageContext.request.contextPath}/resources/bootstrap/images/home.jpg)"></div>
					<div class="container fill_height">
						<div class="row fill_height">
							<div class="col fill_height">
								<div
									...
									<div class="home_content">
										...
										<div class="home_items">
											<div class="row">
												<div class="col-sm-3 offset-lg-1">
													<div class="home_item_side">
														<a href="product.html"><img src="${pageContext.request.contextPath}/resources/bootstrap/images/home_1.jpg"
															alt=""></a>
													</div>
												</div>
												<div
													...
													<div class="product home_item_large">
														...
														<div class="product_image">
															<img src="${pageContext.request.contextPath}/resources/bootstrap/images/product_1.jpg" alt="">
														</div>
														<div class="product_content">
															<div
																class="product_info d-flex flex-row align-items-start justify-content-start">
															...
															<div class="product_buttons">
																<div
																	...
																	<div
																		...
																		<div>
																			<div>
																				<img src="${pageContext.request.contextPath}/resources/bootstrap/images/cart_2.svg" alt="">
																				<div>+</div>
																			</div>
																		</div>
																	</div>
											...
											<div class="row">
												...
												<div
													...
													<div class="product home_item_large">
														...
														<div class="product_image">
															<img src="${pageContext.request.contextPath}/resources/bootstrap/images/product_2.jpg" alt="">
														</div>
														<div class="product_content">
															<div
																class="product_info d-flex flex-row align-items-start justify-content-start">
											...
											<div class="row">
												...
												<div
													...
													<div class="product home_item_large">
														...
														<div class="product_image">
															<img src="${pageContext.request.contextPath}/resources/bootstrap/images/product_3.jpg" alt="">
														</div>
														<div class="product_content">
															<div
																class="product_info d-flex flex-row align-items-start justify-content-start">
